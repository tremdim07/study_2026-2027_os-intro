...
Редактирование через vim горячими клавишами программу. (рис. -@fig:002)

![Редактирование кода](image/2.png){#fig:002 width=70%}

## Запуск программы

Запускаю написанную программу. (рис. -@fig:003)
...
# Вывод
 ...
 Мы познакомились с операционной системой Linux. Получили навыки работы с редактором vi, установленным по умолчанию почти во всех дистрибутивах.
